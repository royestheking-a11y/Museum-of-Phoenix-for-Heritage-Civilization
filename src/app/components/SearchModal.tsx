...
const SEARCH_INDEX: SearchResult[] = [
  ...
  { id: 'hall-2', hall: 2, hallName: "Qur'anic Symbolism", title: "Hall 2: Qur'anic Symbolism", arabic: 'قاعة رموز القرآن', type: 'Hall', description: 'Quranic numbers and animals', descriptionAr: 'الأرقام والحيوانات في القرآن', tags: ['quran', 'islamic', 'sacred', 'hall', 'verses'] },
